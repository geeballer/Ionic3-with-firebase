...
private userId :any;
  ...
  constructor(private navCtrl: NavController, private loadingCtrl: LoadingController,private viewCtrl: ViewController, private postsServiceProvider: PostsServiceProvider, private alertCtrl: AlertController ) {
...
addNewPost(){
	...
	//call the service
	this.postsServiceProvider.createPostService(this.userId, this.postBody).then(() => {
